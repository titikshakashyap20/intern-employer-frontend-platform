...
const conversations = [
    ...
    {
        id: 3,
        name: "InternMatch Mentor",
        lastMessage: "Welcome! Let me know if you have questions.",
        avatar: "",
        time: "3h ago",
        unread: 0,
    },
...
const initialMessages = {
    1: [
        { id: 1, text: "Hey! We were impressed with your application for the Software Engineer Intern role.", sender: "recruiter" },
        { id: 2, text: "I'd love to schedule a brief 15-minute call to discuss your experience. Are you free sometime this week?", sender: "recruiter" },
        { id: 3, text: "Hi John, that sounds great! I'm available on Wednesday and Friday afternoon.", sender: "student" },
        { id: 4, text: "Perfect. Does Friday at 2 PM work for you?", sender: "recruiter" },
    ],
    2: [
        { id: 1, text: "Hi, thanks for applying to the Product Manager internship.", sender: "recruiter" },
        { id: 2, text: "Can you send over your portfolio?", sender: "recruiter" },
    ],
    3: [
        { id: 1, text: "Welcome! Let me know if you have questions.", sender: "recruiter" },
    ]
};
...
export default function MessagesPage() {
    ...
    return (
        <div className="h-[calc(100vh-80px)] flex bg-white rounded-r-lg shadow-lg border border-gray-200 ml-0">
                        ...
                        <div className="flex-1 overflow-y-auto px-6 py-4">
                            <div className="space-y-6">
                                {messages[selectedConversation.id].map((msg) => (
                                    <div key={msg.id} className={`flex items-end gap-3 ${msg.sender === 'student' ? 'justify-end' : 'justify-start'}`}>
                                        ...
                                        <div className={`max-w-md p-3 rounded-2xl ${msg.sender === 'student' ? 'bg-[#7c3aed] text-white rounded-br-none' : 'bg-white text-gray-800 border border-gray-200 rounded-bl-none'}`}>
                                            <p>{msg.text}</p>
                                        </div>
                                    </div>
                                ))}
