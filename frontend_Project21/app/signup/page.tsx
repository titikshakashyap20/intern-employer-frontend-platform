        ...
        <main className="min-h-screen bg-gradient-to-br from-[#f5f6ff] to-[#fdf6fa] flex flex-col">
            ...
            <section className="flex-1 flex flex-col items-center justify-center py-16">
                <div className="bg-white/80 rounded-2xl shadow-lg p-8 w-full max-w-md">
                    <h1 className="text-3xl font-bold mb-6 text-center text-[#7c3aed]">Sign Up</h1>
                    <div className="flex flex-col gap-3 mb-6">
                        ...
                        <button className="flex items-center justify-center gap-3 px-6 py-3 rounded-lg border border-gray-200 bg-white text-gray-700 font-semibold shadow hover:bg-gray-50 transition">
                            <FaLinkedin className="text-xl text-[#0a66c2]" /> Sign up with LinkedIn
                        </button>
                    </div>
                    <form className="flex flex-col gap-4">
                        ...
                        <button type="submit" className="mt-4 px-6 py-3 rounded-lg bg-gradient-to-r from-[#6a6aff] to-[#a259c6] text-white font-semibold shadow-md hover:scale-105 transition-transform">Sign Up</button>
                    </form>
                    <p className="text-center text-gray-500 mt-4">Already have an account? <a href="/signin" className="text-[#a259c6] hover:underline">Sign In</a></p>
                </div>
            </section>
